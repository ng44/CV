...
**Product Management | DevSecOps | SDLC | Data & IT Governance**  
Munich, Germany • nikolaos.georgiadis.01@gmail.com • [LinkedIn](https://linkedin.com/in/nickgeo01) • [GitHub](https://github.com/ng44)

---

## Profile
Experienced professional with five years in energy/power-industry, specializing in product management, data-driven decision support and IT Governance. I focus on enhancing platform reliability, automating CI/CD delivery pipelines and aligning technology initiatives with business objectives to ensure efficient market operations.

---

## 🚀 Core Skills

- **DevOps & CI/CD**: GitLab pipelines, Release Management
- **3rd Level Support**: Root cause analysis, advanced troubleshooting, escalation resolution, RCA documentation, Lean management 
...
- DevSecOps Foundation – DevOps Institute (exam pending)
- ITIL v4 Foundation – Axelos  
- The Physical and Financial Power Markets – Nord Pool 
- Lean Foundation & Practitioner - The Knowledge Academy

---

## 📘 Applied Tools & Courses

- GitLab CI/CD | Grafana | PostgreSQL | Jira | ServiceNow | Confluence | Gurobi | PowerFactory | Grafana
- Other courses: Bash, Docker, SSH, Nmap , Prometheus, Selenium, Postgresql, QGIS, ArcGIS
